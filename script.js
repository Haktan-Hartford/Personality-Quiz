// script.js
 ...
 function showResults() {
     ...
     schoolRecommendations.innerHTML = sortedSchools.map(([schoolId, score]) => {
         return `<li>${schools[schoolId].name} (Score: ${score})</li>`;
     }).join('');
 }
 ...
 function showNextQuestion() {
     ...
     if (selectedValues) {
         ...
         alert("Please select an answer."); // Or a more user-friendly error message
     }
 }
